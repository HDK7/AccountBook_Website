...
<script>
	...
	function check() {
		...
		httpRequest
				.open(
						"POST",
						"http://localhost:8081/AccountBook_Website/MemberPwdSearchController",
						true);
	...
	function callback() {
		if (httpRequest.readyState == 4) {
			...
			if (resultText == 1) {
				...
				//window.close();
				location.href = 'http://localhost:8081/AccountBook_Website/view/pwdSearchSend.jsp?Authkey='
...
<body>
	<br><br><br><br>
	<form action="#" name="pwdSearchTem" method="post"
		onsubmit="return check()" style="text-align: center;">
		<h4>비밀번호를 찾고자 하는 아이디를 입력해 주세요.</h4>
		<input type="text" name="id" id="userId"> <input type="submit" value="다음">
	</form>
</body>
</html>