...
<body>
	...
	<div class="design top">
			...
			<div class="design" id="mem_info">
				<c:if test="${sessionScope.flag eq true }">
					...
					<c:if test="${sessionScope.id ne 'admin' }">
						<!-- 관리자가 아닌 경우 -->
						<a
							href="${pageContext.request.contextPath }/MemberSearchController">회원정보</a>
					</c:if>
				</c:if>
			</div>
		</div>
		<div class="design title">
			<h1>
				<a href="${pageContext.request.contextPath }/view/main.jsp"><img
					src="${pageContext.request.contextPath }/project_main_logo.png"
					height="100"></i>
				</a>
			</h1>
		</div>
