							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="card mb-4 border-left-primary shadow"
										...
										<div class="card-header"
											style="border-bottom: none; background-color: white; margin-left: 0px; margin-right: 0px; text-align: center">
											<h6 class="m-0 font-weight-bold text-primary">가계부 작성</h6>
										</div>
										<div class="card-body">
											<a class="col btn btn-primary btn-lg btn-block"
												href="${pageContext.request.contextPath }/hhSelectMonthController">
								...
								<div class="col-lg-6">
									<div class="card mb-4 border-left-danger shadow"
										...
										<div class="card-body">
											<a class="col btn btn-danger btn-lg btn-block"
												href="${pageContext.request.contextPath }/hhSelectMonthController2">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="card mb-4 border-left-info shadow"
										...
										<div class="card-body">
											<a class="col btn btn-info btn-lg btn-block"
												href="${pageContext.request.contextPath }/household/HouseholdYearView.jsp">
								...
								<div class="col-lg-6">
									<div class="card mb-4 border-left-success shadow"
										...
										<div class="card-header"
											style="border-bottom: none; background-color: white; margin-left: 0px; margin-right: 0px; text-align: center">
											<h6 class="m-0 font-weight-bold text-success">카테고리별 월별
												통계</h6>
										</div>
										<div class="card-body">
											<a class="col btn btn-success btn-lg btn-block"
												href="${pageContext.request.contextPath }/hhSelectCategoryController">
