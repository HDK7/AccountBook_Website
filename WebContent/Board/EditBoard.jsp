		...
		<table border="2" cellspacing="0">
			...
			<tr>
				...
				<td colspan="2"><input type="text"
					value="<%=request.getParameter("sequence")%>" name="sequence"
					size="45" readonly><br>조회수: ${b.viewcount} 추천수: ${b.recommend_cnt}</td>
			</tr>
			<tr>
				<th>작성자</th>
			...
			<tr>
				<td colspan="2"><input type="submit" value="수정"> <input type="button" value="취소" onclick="cancel()"></td>
			</tr>
		</table>
	</form>
</body>
