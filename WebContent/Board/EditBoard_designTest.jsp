									...
									<form 	action="${pageContext.request.contextPath }/EditBoardController" method="post">
										...
										<div class="form-group">
											<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
												<tr>
													<th>글번호</th>
													<td colspan="2"><input class="form-control" type="text" value="<%=request.getParameter("sequence")%>" name="sequence" size="60" readonly><br></td>
												</tr>
												<tr>
													<th>작성자</th>
													<td><input class="form-control" type="text"
														value="<%=request.getParameter("writer")%>" name="writer"
														size="60" readonly></td>
												</tr>
												<tr>
													<th>작성 날짜</th>
													<td><input class="form-control" type="text"
														value="<%=request.getParameter("time")%>" name="time"
														size="60" readonly><br></td>
												</tr>
												<tr>
													<th>글 제목</th>
													<td><input class="form-control" type="text"
														value="<%=title %>" name="title" size="60" ${str }>
													</td>
												</tr>
												<tr>
													<th>글 내용</th>
													<td><textarea class="form-control" rows="20" cols="60"	name="content"><%=content%></textarea>
													</td>
												</tr>
												<tr>
													<td colspan="2"><input
														class="btn btn-secondary float-right" type="button"
														value="취소" onclick="cancel()"> <input
